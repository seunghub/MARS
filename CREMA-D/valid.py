...
def general_model_test():
    ...
    model_path = "./results/cramed/pme/best_model_of_dataset_CREMAD_Normal_beta_0.2_pe_0_optimizer_sgd_modulate_starts_0_ends_50_epoch_90_acc_0.5134408602150538.pth"
