# ECCV 2026 Paper 2562 Segmentation
Our codebase is built upon the official MCubeS baseline of [Multimodal Material Segmentation](https://openaccess.thecvf.com/content/CVPR2022/html/Liang_Multimodal_Material_Segmentation_CVPR_2022_paper.html)
We follow the original training and evaluation settings, and the code can be executed in the same manner as the official implementation.
